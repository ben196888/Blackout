...
Every named box is a playable location; shaded boundaries group neighborhoods. Every line is one bidirectional, one-move road. Red dashed roads close on the labeled day. Double green outlines mark the two possible evacuation sites. Lines crossing without a location box do not create a junction. Layout is schematic: line length and compass direction do not encode travel distance or terrain.
